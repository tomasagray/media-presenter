...
public class WatchVideoAddDirectory implements CommandLineRunner {
  ...
  public WatchVideoAddDirectory(
      RecursiveWatcherService watcherService, VideoScanningService videoScanningService) {
  ...
  public void run(String... args) throws Exception {
    ...
    watcherService.watch(
        ...
        () -> {
          ...
          logger.info(
              "Initial scan of add new video directory completed in {}ms", jobDuration.toMillis());
        });
  }
}
